...
const ecips = [
  ...
  },
  {
    ...
    icon: Cpu,
    description:
      "Building on Mystique and Spiral, Olympia delivers the remaining EVM execution-layer improvements from Dencun, Pectra, and Fusaka. Every EIP is compatible with Proof-of-Work and independent of blob data availability. Exchanges and wallets gain modern RPC compatibility. Developers gain full access to every current Ethereum tool, library, and framework: one codebase, every EVM chain.",
  },
];
          ...
          <div className="relative z-10 mx-auto max-w-4xl px-6 text-center">
            ...
            <FadeIn delay={100}>
              ...
              <ul className="mx-auto mt-6 max-w-2xl space-y-3 text-left text-sm text-[var(--text-muted)]">
                ...
                <li className="flex gap-3">
                  <span className="mt-0.5 shrink-0 text-[var(--brand-green)]">·</span>
                  <span><span className="font-semibold text-[var(--text-primary)]">Institutional infrastructure:</span> the PoW commodity classification path (CLARITY Act) combined with the programmable finance frameworks being built around smart contract platforms (GENIUS Act, MiCA)</span>
                </li>
              </ul>
            </FadeIn>
          </div>
