...
export const metadata: Metadata = {
  ...
  description:
    "Olympia is Ethereum Classic's most significant protocol upgrade. Adds EIP-1559 fee market (ECIP-1111), protocol treasury (ECIP-1112), and full EVM alignment through Dencun, Pectra, and Fusaka (ECIP-1121) — positioning ETC as the Proof-of-Work infrastructure layer for institutional adoption. Upgrade guides for Fukuii and Core-Geth.",
  keywords: [
    "Olympia upgrade",
...
const ecips = [
  ...
  },
  {
    ...
    icon: Cpu,
    description:
      "Building on Mystique and Spiral, Olympia delivers the remaining EVM execution-layer improvements from Dencun, Pectra, and Fusaka — every EIP compatible with Proof-of-Work and independent of blob data availability. Exchanges and wallets gain modern RPC compatibility. Developers gain full access to every current Ethereum tool, library, and framework — one codebase, every EVM chain.",
  },
];
            ...
            <FadeIn delay={100}>
              ...
              <ul className="mx-auto mt-6 max-w-2xl space-y-3 text-left text-sm text-[var(--text-muted)]">
                <li className="flex gap-3">
                  ...
                  <span><span className="font-semibold text-[var(--text-primary)]">EIP-1559 fee market</span> — the most widely adopted transaction type in the EVM ecosystem, bringing predictable gas pricing and modern tooling compatibility</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5 shrink-0 text-[var(--brand-green)]">—</span>
                  <span><span className="font-semibold text-[var(--text-primary)]">Protocol treasury</span> — seeded by basefee revenue and voluntary contributions, funding open-source core development, infrastructure, and long-term network security</span>
                </li>
                <li className="flex gap-3">
                  <span className="mt-0.5 shrink-0 text-[var(--brand-green)]">—</span>
                ...
                <li className="flex gap-3">
                  <span className="mt-0.5 shrink-0 text-[var(--brand-green)]">—</span>
                  <span><span className="font-semibold text-[var(--text-primary)]">Institutional infrastructure</span> — the Proof-of-Work foundation for regulated stablecoins under MiCA and the GENIUS Act, energy grid stabilization, and ETF-compliant digital assets that regulators across the US, EU, Japan, and beyond are moving to define</span>
                </li>
              </ul>
            </FadeIn>
          </div>
        ...
        <section className="py-16 px-6">
          <div className="mx-auto max-w-5xl">
            <FadeIn>
              ...
              <p className="mb-8 text-sm text-[var(--text-muted)]">
                Building on Mystique and Spiral, Olympia delivers the EVM execution-layer improvements from Dencun, Pectra, and Fusaka — every EIP compatible with Proof-of-Work and independent of blob data availability.
              </p>
            </FadeIn>
